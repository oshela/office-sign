...
//set page count
   ...
   $select_query_count ="SELECT * FROM break_start limit $page_1, 30";
...
<body> 
    ...
    <select name="name">
     ...
     <button type="submit" name="search_break_start">search</button>
    </form>
    <table class="tble">
        <tr>
            <th> Staff Name</th>
